...
class BitmapsLoader {
    fun loadArms(armsAndLegsControl: ArmsAndLegsControlActivity): Array<Bitmap?> {
    ...
    fun loadLegs(armsAndLegsControl: ArmsAndLegsControlActivity): Array<Bitmap?> {
    ...
    fun loadLegsBodies(armsAndLegsControl: ArmsAndLegsControlActivity): Array<Bitmap?> {
